...
const char* ui_size_kind_table_string[] = { "UI_Size_Kind_None", "UI_Size_Kind_Relative", "UI_Size_Kind_Fixed", };
...
#define UI_Init_Stacks(ctx) \
  ...
  ctx.size_kind_stack.top_index = 0; ctx.size_kind_stack.bottom_val = UI_Size_Kind_Fixed; \
...
#define UI_Config_Stacks \
  ...
  { \
    ...
    struct UI_Size_Kind_stack { UI_Size_Kind data[32]; u32 top_index; UI_Size_Kind bottom_val; } size_kind_stack; \
...
#define UI_Debug_Stacks_At_Bottom \
  ...
  ui_stack_assert_top_at(size_kind,0); \
