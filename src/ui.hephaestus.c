...
function Vec2f32 ui_top_left_stack_top() { ui_stack_top(top_left); }
function b32  ui_top_left_stack_is_at_bottom() { ui_stack_is_at_bottom(top_left); }
...
function f32 ui_size_x_stack_top() { ui_stack_top(size_x); }
function b32  ui_size_x_stack_is_at_bottom() { ui_stack_is_at_bottom(size_x); }
...
function f32 ui_size_y_stack_top() { ui_stack_top(size_y); }
function b32  ui_size_y_stack_is_at_bottom() { ui_stack_is_at_bottom(size_y); }
...
function f32 ui_padding_x_stack_top() { ui_stack_top(padding_x); }
function b32  ui_padding_x_stack_is_at_bottom() { ui_stack_is_at_bottom(padding_x); }
...
function f32 ui_padding_y_stack_top() { ui_stack_top(padding_y); }
function b32  ui_padding_y_stack_is_at_bottom() { ui_stack_is_at_bottom(padding_y); }
...
function f32 ui_spacing_left_stack_top() { ui_stack_top(spacing_left); }
function b32  ui_spacing_left_stack_is_at_bottom() { ui_stack_is_at_bottom(spacing_left); }
...
function f32 ui_spacing_right_stack_top() { ui_stack_top(spacing_right); }
function b32  ui_spacing_right_stack_is_at_bottom() { ui_stack_is_at_bottom(spacing_right); }
...
function f32 ui_spacing_top_stack_top() { ui_stack_top(spacing_top); }
function b32  ui_spacing_top_stack_is_at_bottom() { ui_stack_is_at_bottom(spacing_top); }
...
function f32 ui_spacing_bottom_stack_top() { ui_stack_top(spacing_bottom); }
function b32  ui_spacing_bottom_stack_is_at_bottom() { ui_stack_is_at_bottom(spacing_bottom); }
...
function UI_Alignment_Kind ui_alignment_kind_stack_top() { ui_stack_top(alignment_kind); }
function b32  ui_alignment_kind_stack_is_at_bottom() { ui_stack_is_at_bottom(alignment_kind); }
...
function UI_Width_Kind ui_width_kind_stack_top() { ui_stack_top(width_kind); }
function b32  ui_width_kind_stack_is_at_bottom() { ui_stack_is_at_bottom(width_kind); }
...
function UI_Height_Kind ui_height_kind_stack_top() { ui_stack_top(height_kind); }
function b32  ui_height_kind_stack_is_at_bottom() { ui_stack_is_at_bottom(height_kind); }
...
function UI_Node_Color_Scheme ui_node_color_scheme_stack_top() { ui_stack_top(node_color_scheme); }
function b32  ui_node_color_scheme_stack_is_at_bottom() { ui_stack_is_at_bottom(node_color_scheme); }
...
function Color ui_border_color_stack_top() { ui_stack_top(border_color); }
function b32  ui_border_color_stack_is_at_bottom() { ui_stack_is_at_bottom(border_color); }
...
function Color ui_background_color_stack_top() { ui_stack_top(background_color); }
function b32  ui_background_color_stack_is_at_bottom() { ui_stack_is_at_bottom(background_color); }
...
function Color ui_background_hover_color_stack_top() { ui_stack_top(background_hover_color); }
function b32  ui_background_hover_color_stack_is_at_bottom() { ui_stack_is_at_bottom(background_hover_color); }
...
function Color ui_background_active_color_stack_top() { ui_stack_top(background_active_color); }
function b32  ui_background_active_color_stack_is_at_bottom() { ui_stack_is_at_bottom(background_active_color); }
...
function Color ui_text_color_stack_top() { ui_stack_top(text_color); }
function b32  ui_text_color_stack_is_at_bottom() { ui_stack_is_at_bottom(text_color); }
...
function Color ui_text_hover_color_stack_top() { ui_stack_top(text_hover_color); }
function b32  ui_text_hover_color_stack_is_at_bottom() { ui_stack_is_at_bottom(text_hover_color); }
...
function Color ui_text_active_color_stack_top() { ui_stack_top(text_active_color); }
function b32  ui_text_active_color_stack_is_at_bottom() { ui_stack_is_at_bottom(text_active_color); }
function void ui_text_active_color_stack_assert_top_at(u32 at) { ui_stack_assert_top_at(text_active_color, at); }
#define ui_text_active_color(val) DeferLoop(text_active_color_stack_push(val), text_active_color_stack_pop())
