...
#define ui_stack_defer_if_default(name,val) DeferLoop(ui_stack_is_at_bottom(name) && (ui_stack_push(name,val),1), (ui_context.name##_stack.top_index == 1) && (ui_stack_pop(name), 1))
